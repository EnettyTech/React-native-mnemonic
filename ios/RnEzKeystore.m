...
@implementation RnEzKeystore

- (dispatch_queue_t)mothodQueue
{
    return dispatch_queue_create("wallet.ez.keystore_queue", DISPATCH_QUEUE_CONCURRENT);
}
RCT_EXPORT_MODULE()
